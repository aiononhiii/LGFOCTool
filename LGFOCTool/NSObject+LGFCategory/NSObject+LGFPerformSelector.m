...
[NSObject lgf_SetInv:inv withSig:sig andArgs:args]; \
va_end(args);

- (id)lgf_PerformSelectorWithArgs:(SEL)sel, ...{
    INIT_INV(sel, nil);
    [inv invoke];
    return [NSObject lgf_GetReturnFromInv:inv withSig:sig];
}
...
- (id)lgf_PerformSelectorWithArgsOnMainThread:(SEL)sel waitUntilDone:(BOOL)wait, ...{
...
#pragma clang diagnostic pop
    ...
    return wait ? [NSObject lgf_GetReturnFromInv:inv withSig:sig] : nil;
}

- (id)lgf_PerformSelectorWithArgs:(SEL)sel onThread:(NSThread *)thr waitUntilDone:(BOOL)wait, ...{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wvarargs"
    INIT_INV(wait, nil);
#pragma clang diagnostic pop
...
+ (id)lgf_GetReturnFromInv:(NSInvocation *)inv withSig:(NSMethodSignature *)sig {
...
+ (void)lgf_SetInv:(NSInvocation *)inv withSig:(NSMethodSignature *)sig andArgs:(va_list)args {
...
- (void)lgf_PerformSelector:(SEL)selector afterDelay:(NSTimeInterval)delay {
