...
/**
 ...
 `NSString` -> NSDate, parsed with format "INSINS-MM-dd'T'HH:mm:ssZ", "INSINS-MM-dd HH:mm:ss" or "INSINS-MM-dd".
 `NSString` -> NSURL.
 ...
 */
@interface NSDictionary (INSModel)
...
/**
 ...
 There's no need to add '<INSModel>' to your class header.
 */
@protocol INSModel <NSObject>
@optional
